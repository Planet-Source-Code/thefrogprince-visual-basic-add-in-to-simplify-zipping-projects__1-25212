...
' Date:     1 January 2000
'
' Requires: Info-ZIP's Zip32.DLL v2.32, renamed to vbZIP32.dll
'           cUnzip.cls
'
...
Private Declare Function ZpInit Lib "vbZIP32.dll" (ByRef tUserFn As ZIPUSERFUNCTIONS) As Long ' Set Zip Callbacks
Private Declare Function ZpSetOptions Lib "vbZIP32.dll" (ByRef tOpts As ZPOPT) As Long ' Set Zip options
Private Declare Function ZpGetOptions Lib "vbZIP32.dll" () As ZPOPT ' used to check encryption flag only
Private Declare Function ZpArchive Lib "vbZIP32.dll" (ByVal argc As Long, ByVal funame As String, ByRef argv As ZIPnames) As Long ' Real zipping action
...
Public Function VBZip( _
      ...
      Optional ByRef oErr As clsError _
   ) As Long
